        ...
        <form action="/account-request/approval/{{ $item->id }}" method="post">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title fs-5" id="confirmationRejectLabel">Konfirmasi Non-Aktifkan Akun</h4>
                ...
                <div class="modal-body">
                    ...
                    <span>Apakah anda yakin akan menonaktifkan akun ini?</span>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                    <button type="submit" class="btn btn-outline-danger">Setuju</button>
                </div>
            </div>
        </form>
    </div>
